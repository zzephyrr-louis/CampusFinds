...
function AdminPanel() {
    const [users, setUsers] = useState([
        { id: 1, name: 'Jake Alipin', email: 'jakealipin@example.com', role: 'Admin', status: 'Active' },
        { id: 2, name: 'Virgil Llera', email: 'virgil@example.com', role: 'User', status: 'Active' },
        { id: 3, name: 'Edrian Responte', email: 'edrian@example.com', role: 'User', status: 'Suspended' }
    ]);
